       ...
       <Nav />
        {
         ...
         <div>
           ...
           <h3 className={Style.title}>{user.type ===`buyer` ? "EDIT BUYER INFORMATION" : user.type === `seller`? "EDIT SELLER INFORMATION": user.type === `deliveryman`? "EDIT DELIVERYMAN INFORMATION": null}</h3>
             <br />
           <Form>
